...
public abstract class BaseControl
{
    ...
    protected Manager
        m_manager; // Controls are related to a manager, where the theme resides and control groups can be implemented
    ...
    } // Disabled - Greyed out and not interactive, Normal - interactive and operational, Hover - currently under the user's mouse focus, Click - user is interacting with the control
}