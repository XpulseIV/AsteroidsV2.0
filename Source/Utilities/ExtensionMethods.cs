...
namespace AstralAssault.Source.Utilities
{
    public static class ExtensionMethods
    {
        ...
        public static Int32 twoDToOneD((Int32, Int32) coordinates, Int32 rowWidth) =>
            coordinates.Item1 + coordinates.Item2 * rowWidth;
